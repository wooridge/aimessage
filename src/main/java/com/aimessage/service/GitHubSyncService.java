...
public class GitHubSyncService {
    ...
    public GitHubSyncService(GitHubProjectRepository gitHubProjectRepository, WebClient webClient) {
            ...
            if (items != null && items.isArray()) {
                for (JsonNode item : items) {
                    try {
                        ...
                        project.setDescription(descNode != null && !descNode.isNull() ? descNode.asText() : "");
